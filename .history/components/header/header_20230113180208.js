...
export default function Header(){
    ...
    return(
        <FlexBox width="100vw" height="fit-content" bgColor="#eae3d9" padding="0 0 0 10%" margin="0 0 20px 0" justifyContent="flex-start">
            <FlexBox alignItems="end" justifyContent="space-around">
                <Text fontSize="50px" color="rgb(25, 50, 108)" fontWeight="bold" margin="0 12px 0 0">Expo Line</Text>
