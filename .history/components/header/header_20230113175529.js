...
export default function Header(){
    ...
    return(
        <FlexBox width="100vw" height="fit-content" bgColor="#eae3d9" padding="20px" margin="0 0 20px 0">
            <FlexBox alignItems="end" width="55%" justifyContent="space-around">
                <Text fontSize="50px" color="rgb(25, 50, 108)" fontWeight="bold">Expo Line</Text>
                <Text fontSize="25px" margin="0 0 7px 0" color="rgb(25, 50, 108)" fontWeight="bold">Expo Line route made with Next.js / React Leaflet</Text>
            </FlexBox>
        </FlexBox>
    )
}
