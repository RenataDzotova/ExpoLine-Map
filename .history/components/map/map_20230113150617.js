...
export default function Map(){
    ...
    const markers = [
        {popUp: "Burrard Station", coordinate:polyline[1]},
        {popUp: "Granville Station", coordinate:polyline[2]},
        {popUp: "Stadium - Chinatown Station", coordinate:polyline[3]},
        {popUp: "Main Street - Science World Station", coordinate:polyline[4]},
        {popUp: "Commercial Broadway Station", coordinate:polyline[5]},
        {popUp: "Nanaimo Station", coordinate:polyline[6]},
        {popUp: "29th Avenue Station", coordinate:polyline[7]},
        {popUp: "Joyce - Collingwood Station", coordinate:polyline[8]},
        {popUp: "Patterson Station", coordinate:polyline[9]},
        {popUp: "Metrotown Station", coordinate:polyline[10]},
        {popUp: "Royal Oak Station", coordinate:polyline[11]},
        {popUp: "Edmonds Station", coordinate:polyline[12]},
        {popUp: "22nd Street Station", coordinate:polyline[13]},
        {popUp: "New Westminister Station", coordinate:polyline[14]},
        {popUp: "Columbia Station", coordinate:polyline[15]},
        {popUp: "Sapperton Station", coordinate:polyline[16]},
        {popUp: "Braid Station", coordinate:polyline[17]},
        {popUp: "Lougheed Town Centre Station", coordinate:polyline[18]},
    ]
