...
export default function Map(){
    ...
    return (
        ...
        <MapContainer className={style.map} center={position} zoom={14} schrollWheelZoom={true}>
            ...
            <CircleMarker center={polyline[16]} pathOptions={redOption} radius={20}>
                <Popup> You reached your destination </Popup>
            </CircleMarker>

            <CircleMarker center={polyline[5]} pathOptions={blueOption} radius={20}>
